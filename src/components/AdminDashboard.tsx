        ...
        <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm sticky top-24">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center gap-2 py-2">
              ...
              />
              <label htmlFor="isBreaking" className="text-sm font-bold text-blue-600">סמן כמתפרץ</label>
            </div>

            <button
              type="submit"
              disabled={isSubmitting}
              className="w-full bg-blue-600 text-white py-3 rounded-lg font-bold hover:bg-blue-700 transition-all shadow-lg active:scale-[0.98] disabled:opacity-50 flex items-center justify-center gap-2"
            >
              ...
              <div key={msg.id} className="flex items-center justify-between p-4 rounded-xl border border-gray-50 hover:bg-gray-50 transition-colors">
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    {msg.isBreaking && <span className="w-2 h-2 bg-blue-600 rounded-full animate-pulse" />}
