...
export default function BreakingTicker() {
  ...
  return (
    <div className="bg-red-600 text-white py-2 overflow-hidden relative h-10 flex items-center">
      <div className="absolute left-0 top-0 bottom-0 bg-red-700 px-4 z-10 flex items-center font-bold italic uppercase tracking-tighter">
