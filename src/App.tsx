          ...
          <div className="min-h-screen bg-gray-50 text-right" dir="rtl">
            ...
            <footer className="bg-white border-t border-gray-200 py-8 mt-12">
              <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4">
                <div className="text-2xl font-black tracking-tighter text-blue-600 italic">
                  מבזקון
                </div>
                <div className="text-sm text-gray-500 font-medium">
                  © {new Date().getFullYear()} כל הזכויות שמורות למערכת מבזקון
                </div>
                <nav className="flex items-center gap-6 text-xs font-bold text-gray-400 uppercase tracking-widest">
                  <a href="#" className="hover:text-blue-600 transition-colors">אודות</a>
